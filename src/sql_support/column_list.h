/// @file column_list.h
/// Declaration of the class tbe::sql::ColumnList.

#ifndef TEXT_BASED_ENGINE_SQL_SUPPORT_COLUMN_LIST_H
#define TEXT_BASED_ENGINE_SQL_SUPPORT_COLUMN_LIST_H
...
class ColumnList
{
  public:
    ...
    /// @param[in] columns Gets swapped with @ref columns_.
    ColumnList(ColumnInfoList& columns);

    /// @param[in] columns Gets copied to @ref columns_.
    ...
    ///
    /// @param[in] column The column to be modified and copied.
